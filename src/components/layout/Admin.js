...
function Admin({ children }) {
  ...
  if (error) {
    return <div className="flex min-h-screen items-center justify-center text-red-500 text-sm">
      {error}
    </div>;
  }
  ...
  return (
    <div className="flex bg-gray-50">
      {/* Sidebar */}
      <aside className="group fixed md:static left-0 bottom-0 md:top-0 h-14 md:h-screen w-full md:w-14 hover:md:w-56 transition-all duration-300 ease-in-out bg-white border-t md:border-r border-gray-200 dark:border-gray-700 p-3">
