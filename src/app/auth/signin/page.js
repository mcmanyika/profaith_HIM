        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-gray-50 to-gray-100 p-12">
          <div className="text-center text-gray-600">
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-semibold text-gray-800 mb-4 uppercase">Download Our App</h3>
              
              <div className="flex gap-3 justify-center">
                {/* iPhone Download Button */}
                <a
                  href="#"
                  className="flex items-center justify-center gap-2 bg-gray-600 text-white py-2 px-3 rounded-lg hover:bg-gray-700 transition duration-200 font-medium text-xs"
                  onClick={(e) => {
                    e.preventDefault()
                    // Add your iPhone app download logic here
                    alert('iPhone app download link will be added here')
                  }}
                >
                ...
                <a
                  href="#"
                  className="flex items-center justify-center gap-2 bg-green-600 text-white py-2 px-3 rounded-lg hover:bg-green-700 transition duration-200 font-medium text-xs"
                  onClick={(e) => {
                    e.preventDefault()
                    // Add your Android app download logic here
                    alert('Android app download link will be added here')
                  }}
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M17.523 15.34l.145-2.532a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 .5.5l.145 2.532a.5.5 0 0 1-.5.5h-1.5a.5.5 0 0 1-.5-.5zm-11.046 0l.145-2.532a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 .5.5l.145 2.532a.5.5 0 0 1-.5.5h-1.5a.5.5 0 0 1-.5-.5zm11.046-4.34l.145-2.532a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 .5.5l.145 2.532a.5.5 0 0 1-.5.5h-1.5a.5.5 0 0 1-.5-.5zm-11.046 0l.145-2.532a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 .5.5l.145 2.532a.5.5 0 0 1-.5.5h-1.5a.5.5 0 0 1-.5-.5z"/>
                    <path d="M7.5 2h9l.5.5v19l-.5.5h-9l-.5-.5v-19L7.5 2zM8 3v18h8V3H8z"/>
                  </svg>
